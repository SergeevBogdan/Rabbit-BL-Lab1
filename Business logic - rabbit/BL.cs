...
namespace Business_logic___rabbit
{
    ...
    public class Logic : ILogic
    {
        ...
        /// <summary>
        /// Основный конструктор для внедрения зависимостей через Ninject
        /// Получает все зависимости автоматически из DI-контейнера
        /// </summary>
        /// <param name="repository">Реализация репозитория для работы с данными</param>
        /// <param name="adder">Сервис для добавления кроликов</param>
        /// <param name="remover">Сервис для удаления кроликов</param>
        /// <param name="reader">Сервис для чтения информации о кроликах</param>
        /// <param name="updater">Сервис для обновления данных кроликов</param>
        /// <param name="ageCalculator">Сервис для расчета среднего возраста</param>
        /// <param name="weightCalculator">Сервис для расчета среднего веса</param>
        /// <param name="sorter">Сервис для сортировки кроликов</param>
        /// <param name="randomCreator">Сервис для создания случайных кроликов</param>
        /// <param name="displayer">Сервис для отображения кроликов</param>
        /// <param name="breedProvider">Сервис для работы с породами кроликов</param>
        public Logic(
            ...
            IRabbitBreedProvider breedProvider)
        {
            ...
            _technology = repository is EntityRepository ? "Entity Framework" : "Dapper";
